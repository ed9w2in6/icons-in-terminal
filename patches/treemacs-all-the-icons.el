...
;; Package-Version: 20220911.1427
;; Package-Commit: 861418d9d11b205930bd4555a40b430b9dde9dd4
;; Version: 0
...
(treemacs-create-theme "all-the-icons"
  ...
  (progn
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "bower" :v-adjust 0 :face 'all-the-icons-orange) treemacs-all-the-icons-tab) :extensions ("bower.json") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "cplusplus-line" :v-adjust 0 :face 'all-the-icons-purple) treemacs-all-the-icons-tab) :extensions ("tpp") :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "clojure-line" :v-adjust 0 :face 'all-the-icons-blue) treemacs-all-the-icons-tab) :extensions ("edn" "clj" "cljs" "cljc") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "coffeescript" :v-adjust 0 :face 'all-the-icons-dorange) treemacs-all-the-icons-tab) :extensions ("coffeescript" "coffee") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "python" :v-adjust 0 :face 'all-the-icons-dblue) treemacs-all-the-icons-tab) :extensions ("py") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "java" :v-adjust 0 :face 'all-the-icons-orange) treemacs-all-the-icons-tab) :extensions ("java" "jar") :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "javascript" :v-adjust 0 :face 'all-the-icons-orange) treemacs-all-the-icons-tab) :extensions ("js") :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "html5" :v-adjust 0 :face 'all-the-icons-orange) treemacs-all-the-icons-tab) :extensions ("html") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-faicon "css3" :v-adjust 0 :face 'all-the-icons-dblue) treemacs-all-the-icons-tab) :extensions ("css") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "video" :v-adjust 0 :face 'all-the-icons-lblue) treemacs-all-the-icons-tab) :extensions ("avi" "mp4" "webm" "mov") :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-faicon "music" :v-adjust 0 :face 'all-the-icons-lblue) treemacs-all-the-icons-tab) :extensions ("mp3" "midi") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "perl" :v-adjust 0 :face 'all-the-icons-dblue) treemacs-all-the-icons-tab) :extensions ("perl") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "prolog" :v-adjust 0 :face 'all-the-icons-orange) treemacs-all-the-icons-tab) :extensions ("prolog") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "sqlite" :v-adjust 0 :face 'all-the-icons-blue) treemacs-all-the-icons-tab) :extensions ("sqlite" "db3" "sqlite3" "db") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "terminal" :v-adjust 0 :face 'all-the-icons-green) treemacs-all-the-icons-tab)
                          :extensions ("zshrc" "zshenv" "zprofile" "zlogin" "zlogout" "bash" "zsh" "sh"
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "excel" :v-adjust 0 :face 'all-the-icons-green) treemacs-all-the-icons-tab) :extensions ("ods" "fods" "xls" "xlsx") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-octicon "file-media" :v-adjust 0 :face 'all-the-icons-orange) treemacs-all-the-icons-tab)
                          :extensions ("tif" "tiff" "bmp" "psd" "ai" "eps" "indd" "png" "jpg" "jpeg" "webp" "giff") :fallback 'same-as-icon)
    ...
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-octicon "file-text" :v-adjust 0 :face 'treemacs-all-the-icons-file-face) treemacs-all-the-icons-tab)
                          :extensions ("rst" "CONTRIBUTE" "LICENSE" "README" "CHANGELOG")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-octicon "markdown" :v-adjust 0 :face 'treemacs-all-the-icons-file-face) treemacs-all-the-icons-tab)
                          :extensions ("md" "markdown")
                          :fallback 'same-as-icon)
    (treemacs-create-icon :icon (format "  %s%s" (all-the-icons-fileicon "org" :v-adjust 0 :face 'treemacs-all-the-icons-file-face) treemacs-all-the-icons-tab)
                          :extensions ("org")
                          :fallback 'same-as-icon)
